...
import styles from '../styles/equipamentos_list.module.css';
        ...
        {equipamentos.map((equipamento) => (
          <tr key={equipamento.id}>
            ...
            <td className={styles.actions}>
              <button onClick={() => onEdit(equipamento)} className={styles.editButton}>
              ...
              <button onClick={() => onDelete(equipamento)} className={styles.deleteButton}>
